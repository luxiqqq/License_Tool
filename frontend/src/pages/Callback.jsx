...
const Callback = () => {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            const response = await axios.post(`https://khondor03-license-checker.hf.space/api/analyze`, {
    ...
    const handleRegenerate = async () => {
        ...
        try {
            const regenResponse = await axios.post(`https://khondor03-license-checker.hf.space/api/regenerate`, analysisData);
    ...
    const handleDownload = async () => {
        if (!cloneData) return;
        try {
            const response = await axios.post('https://khondor03-license-checker.hf.space/api/download', {
                owner: cloneData.owner,
                repo: cloneData.repo
            }, { responseType: 'blob' });
